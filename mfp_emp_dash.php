...
function viewEmployeeData($conn) {
    $query = "SELECT * FROM mfp_emp_dash";
...
if(isset($_POST["submit"])) {
    ...
    $query = "INSERT INTO mfp_emp_dash (add_user,employeeName, dob, qualification, salary, address, aadhar, spouse, children) VALUES ('$add_user','$employeeName', '$dob', '$qualification', '$salary', '$address', '$aadhar', '$spouse', '$children')";
