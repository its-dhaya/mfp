...
function viewRetailerData($conn) {
    $query = "SELECT * FROM mu_retailer_dash";
...
if(isset($_POST["submit"])) {
    ...
    if(isset($_SESSION['username'])) {
        ...
        $query = "INSERT INTO mu_retailer_dash (add_user,dob, qualification, shop_name, current_profit, address, aadhar, spouse, children) VALUES ('$add_user','$dob', '$qualification', '$shopName', '$currentProfit', '$address', '$aadhar', '$spouse', '$children')";
        ...
        echo "<script>alert('Error: Username session variable not set');</script>";
    }
}
...
<body>
<form method="post"> <!-- Added form tag here -->
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="date" class="form-control" id="dob" name="dob"> <!-- Added name attribute -->
                            </div>
                            <div class="form-group">
                                <label for="qualification">Educational Qualification:</label>
                                <input type="text" class="form-control" id="qualification" name="qualification"> <!-- Added name attribute -->
                            </div>
                            <div class="form-group">
                                <label for="shop_name">Shop name:</label> <!-- Updated id and name attribute -->
                                <input type="text" class="form-control" id="shop_name" name="shop_name">
                            </div>
                            <div class="form-group">
                                <label for="current_profit">Current profit (Rs):</label> <!-- Updated id and name attribute -->
                                <input type="text" class="form-control" id="current_profit" name="current_profit">
                            </div>
                            <div class="form-group">
                                <label for="address">Residential Address:</label>
                                <textarea class="form-control" id="address" name="address"></textarea> <!-- Added name attribute -->
                            </div>
                            <div class="form-group">
                                <label for="aadhar">Aadhar Number:</label>
                                <input type="text" class="form-control" id="aadhar" name="aadhar"> <!-- Added name attribute -->
                            </div>
                            <div class="form-group">
                                <label for="spouse">Spouse/Parent Name:</label>
                                <input type="text" class="form-control" id="spouse" name="spouse"> <!-- Added name attribute -->
                            </div>
                            <div class="form-group">
                                <label for="children">No. of Children:</label>
                                <input type="number" class="form-control" id="children" name="children"> <!-- Added name attribute -->
                            </div>
                            <button type="submit" class="btn btn-primary btn-block" name="submit">Save</button> <!-- Added name attribute -->
                        </form>
                    </div>
                </div>
            </div>
