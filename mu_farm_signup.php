...
if(isset($_POST["submit"])) {
    ...
    if(mysqli_num_rows($duplicate) > 0) {
        ...
        if($password == $confirm_password) {
             $query = "INSERT INTO mu_farm (spv_name, district_name, state_name, manufacturing_unit, farmer_name, ppc_connected, cc_connected, DOJ, email, contact_number, username, password) VALUES ('$spv_name', '$district_name', '$state_name', '$manufacturing_unit', '$farmer_name', '$ppc_connected', '$cc_connected', '$DOJ', '$email', '$contact_number', '$username', '$password')";
...
<div class="container mt-5">
    <div class="row justify-content-center">
      <div class="col-md-6 container-box">
        <h2 class="text-center mb-4">MU Farmer Signup</h2>
